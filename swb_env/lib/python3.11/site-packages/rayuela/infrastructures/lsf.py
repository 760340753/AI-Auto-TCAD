"""Provide an :class:`Infrastructure` to run tasks on lsf hosts."""
...
_identity_parameters = [
    ...
    _parameter(LSFJob, "lsf_units", _Optional[str], kind=_Parameter.KEYWORD_ONLY),
    _parameter(LSFJob, "mem", _Optional[int], kind=_Parameter.KEYWORD_ONLY),
    _parameter(LSFJob, "ncpus", _Optional[int], kind=_Parameter.KEYWORD_ONLY),
    _parameter(LSFJob, "project", _Optional[str], kind=_Parameter.KEYWORD_ONLY),
    _parameter(LSFJob, "queue", _Optional[str], kind=_Parameter.KEYWORD_ONLY),
    _parameter(LSFJob, "use_stdin", _Optional[bool], kind=_Parameter.KEYWORD_ONLY),
    _parameter(LSFJob, "walltime", _Optional[str], kind=_Parameter.KEYWORD_ONLY),
]
...
class LSFInfrastructure(_AdaptOnFirstSubmit, _Infrastructure):
    """:class:`Infrastructure` that can run tasks on the lsf host."""
    ...
    def __init__(self, **kwargs):
        """Configure a :class:`dask_jobqueue.LSFCluster`."""
        ...
        with _catch_warnings():
            ...
            self._cluster = _LSFCluster(*bound_args.args, **bound_args.kwargs)
    ...
    def get_cluster(self):
        """Return an instance of :class:`dask_jobqueue.LSFCluster`."""
...
# ****************************************
# @(&)Synopsys_Unique_Signature Libname="lsf.py" Name="RAYUELA" Version="4.0.0" Type="REUSE" Injector="V-2023.09-DEV (8729328)"(&)@
