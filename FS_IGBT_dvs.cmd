...
(define Wgate     @Wgate@)       ; Width of the gate electrode (emitter aperture)
(define Wnplus    @Wnplus@)       ; Width of the n+ cathode-short region
(define Wpplus    @Wpplus@)       ; Width of the p+ pocket implants on either side of the gate
(define Wemitter  @Wemitter@)       ; Lateral extent of the emitter contact region

;-- Vertical (depth) dimensions (in microns)
(define Ymax       @Ymax@)    ; Total device depth (substrate bottom to surface)
(define Ygate       @Ygate@)     ; Vertical height of the gate poly above the surface
(define Ypplus      @Ypplus@)     ; Depth of the p+ pocket implants
(define Ynplus      @Ynplus@)     ; Depth of the n+ cathode-short implant
...
(define Hcollector   @Hcollector@)    ; Depth of the p+ collector (anode) implant
...
(define Pplus      @Pplus@)  ; Boron for p+ pockets 
(define Nplus      @Nplus@ ) ; Phosphorus for n+ regions (1x10^19)
(define Nbuffer    @Nbuffer@ ) ; Peak concentration of n-buffer (field-stop)
(define Pcollector @Pcollector@ )  ; Boron for p+ collector (1x10^17)

;Gate oxide sidewall and bottom thickness (in microns)
(define Tox_sidewall @Tox_sidewall@)      ; Oxide thickness on the trench sidewalls
(define Tox_bottom   @Tox_bottom@)     ; Oxide thickness under the gate bottom
