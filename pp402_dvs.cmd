...
(define Xmax      6)    ; Total half-cell width of the IGBT
...
(define Ymax       100)    ; Total device depth (substrate bottom to surface)
(define Ygate       5)     ; Vertical height of the gate poly above the surface
(define Ypplus      0.5)     ; Depth of the p+ pocket implants
(define Ynplus      0.5)     ; Depth of the n+ cathode-short implant
(define Ypbase     3)  ; Depth of the P-base region (profile edge)
(define Hnbuffer   4) ; Depth of the n-buffer (field-stop) layer
...
(define Ndrift     5e13)   ; Lightly doped drift layer
(define Pbase      2.5e17)    ; Peak concentration of the P-base Gaussian
(define Pplus      1e19)  ; Boron for p+ pockets 
(define Nplus      1e19 ) ; Phosphorus for n+ regions (1x10^19)
(define Nbuffer    5e15 ) ; Peak concentration of n-buffer (field-stop)
(define Pcollector 1e+17 )  ; Boron for p+ collector (1x10^17)
...
;############# Save and Build Mesh #############
(sde:save-model "n402")   ; Save the combined geometry+doping model
(sde:build-mesh "n402")   ; Generate the finite element mesh for simulation
